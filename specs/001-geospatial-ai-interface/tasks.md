...
- [ ] T016 [US1] Implement the `/chat` API endpoint (`backend/src/api/chat.py`)
- [ ] T017 [P] [US1] Create the main chat window component in the frontend (`frontend/src/components/ChatWindow.jsx`)
